...
const VARIETIES = [
  ...
  'Gamay', 'Glera', 'Greco', 'Grenache', 'Grillo', 'Grüner Veltliner', 'Malbec', 'Marsanne', 'Merlot',
  'Montepulciano', 'Moscato', 'Mourvèdre', 'Muscat', 'Nebbiolo', 'Negroamaro', 'Nero d’Avola',
  'Petit Verdot', 'Pinot Grigio', 'Pinot Gris', 'Pinot Meunier', 'Pinot Noir', 'Pinotage', 'Primitivo',
