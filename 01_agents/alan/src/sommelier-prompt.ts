...
export function researchSystemPrompt(lang: Lang): string {
  ...
  return [
    ...
    "   front and back of the SAME bottle — use both. COMMIT to the ONE color/style of the bottle",
    "   in front of you (red / white / rosé / sparkling). If a color is given in the prompt or",
    "   visible on the label/bottle, assess ONLY that color — do NOT describe the producer's other",
    "   cuvées or hedge across colors. Many châteaux make both red and white; you are reviewing one.",
