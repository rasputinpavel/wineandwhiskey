...
COPY = {
    "curate": {
        "en": {
            ...
            "primary": "Tell us the date and the vibe — we'll curate the drinks. With and without alcohol, matched to your budget.",
            "cta": "Message us",
        },
        "ru": {
    ...
    "brief": {
        ...
        "ru": {
            "headline": "ТВОЯ ВЕЧЕРИНКА — ТВОЙ БЮДЖЕТ.",
    ...
    "bulk": {
        ...
        "ru": {
            "headline": "БОЛЬШЕ ГОСТЕЙ — ИНТЕРЕСНЕЕ ЦЕНА.",
